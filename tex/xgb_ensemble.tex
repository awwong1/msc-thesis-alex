...
In this chapter, I propose an approach for the classification of 12-Lead ECGs using manual feature engineering and an ensemble of gradient boosted trees.
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=7.9cm]{figure/xgb_methodology.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=7.9cm]{figure/top_features_bar.png}
...
\begin{figure}[hb]
  \centering
  \includegraphics[width=7.9cm]{figure/classification_metrics_phase_1_2.png}
...
\begin{figure*}[ht]
  \centering
  \includegraphics[width=\textwidth]{figure/label_f1s.png}
